/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 1f58050df5b13739eaf99bfaee509fea)
...
interface __BaseEnv_CloudflareBindings {
	...
	DB: D1Database;
	PACK_ASSETS: Fetcher;
	WEB_ORIGIN: "https://fgsim.colloid.dev";
	API_ORIGIN: "https://api.fgsim.colloid.dev";
	JWT_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WEB_ORIGIN" | "API_ORIGIN" | "JWT_SECRET">> {}
}
